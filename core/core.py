...
if website.status_code == 200:
    ...
    getDivContents = html.find(class_="mag-box mini-posts-box has-custom-color")
    getContents = getDivContents.find_all(class_="post-title")
    ...
    for x in getContents:
        ...
        if openLink:
            ...
            print(content3.find_all(class_="result"))
